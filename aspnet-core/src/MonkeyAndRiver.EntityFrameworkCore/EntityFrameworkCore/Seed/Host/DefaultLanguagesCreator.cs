...
namespace MonkeyAndRiver.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly MonkeyAndRiverDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = MonkeyAndRiverConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(MonkeyAndRiverDbContext context)
        {
            _context = context;
        }
