...
{
    public abstract class MonkeyAndRiverWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MonkeyAndRiverWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MonkeyAndRiverWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MonkeyAndRiverDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MonkeyAndRiverDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MonkeyAndRiverDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MonkeyAndRiverDbContext, Task<T>> func)
        {
            T result;
